...
<div class="hot_shop">
					...
					<ul>
						...
						<li><span></span><img src="images/lanshan.jpg" />
							...
							<div><input type="button" value="查看详情" /><button><a href="addGoods.jsp?path=lanshan.jpg&&Id=01&&name=蓝山咖啡豆&&decribe=中度烘焙 口感均衡&&price=￥ 89.00&&color=蓝色" >加入购物车</a> </button></div>
						</li>
						...
						<li><span></span><img src="images/moka.jpg" />
							...
							<h4>￥ 69.00</h4>
							<div><input type="button" value="查看详情" /> <button><a href="addGoods.jsp?path=moka.jpg&&Id=02&&name=摩卡咖啡豆&&decribe=柔和果酸 坚果余味&&price=￥ 69.00&&color=红色 ">加入购物车</a> </button></div>
						</li>
						...
						<li><span></span><img src="images/rishi.jpg" />
							...
							<h4>¥ 59.00</h4>
							<div> <input style="margin-left:10px; " type="button" value="查看详情" /> <bttton><a href="addGoods.jsp?path=rishi.jpg&&Id=03&&name=日式炭烧咖啡豆&&decribe=虽苦不涩 回甘强烈&&price=¥ 59.00&&color=棕色  ">加入购物车</a> </button></div>
						</li>
						...
						<li><span></span><img src="images/yishi.jpg" />
							...
							<h4>￥ 59.00</h4>
							<div> <input type="button" value="查看详情" /> <button><a href="addGoods.jsp?path=yishi.jpg&&Id=05&&name=意式咖啡豆&&decribe=细腻丰厚 烈苦无酸&&price=￥ 59.00&&color=紫色  ">加入购物车</a> </button> </div>
						</li>
						...
						<li><span></span><img src="images/mantening.jpg" />
							...
							<p>服装大爆炸</p><span></span>
							<h4>¥ 59.00</h4>
							<div> <input type="button" value="查看详情" /> <button><a href="addGoods.jsp?path=mantening.jpg&&Id=04&&name=曼特宁咖啡豆&&decribe=服装大爆炸，带你走向时尚&&price=¥ 59.00&&color=棕色  ">加入购物车</a> </button></div>
						</li>
						...
						<li><span></span><img src="images/gelunbiya.jpg" />
							...
							<h4>¥ 59.00</h4>
							<div> <input type="button" value="查看详情" /> <button><a href="addGoods.jsp?path=gelunbiya.jpg&&Id=06&&name=哥伦比亚咖啡豆&&decribe=清新湿香 明朗果酸&&price=￥ 59.00&&color=绿色  ">加入购物车</a> </button></div>
						</li>
						...
						<li><span></span><img src="images/xiangchun.jpg" />
							...
							<h4>¥ 59.00</h4>
							<div> <input type="button" value="查看详情" /><button><a href="addGoods.jsp?path=xiangchun.jpg&&Id=07&&name=香醇咖啡豆&&decribe=元气满满 黑巧口味&&price=￥ 59.00&&color=红色  ">加入购物车</a> </button></div>
							</li>
						<li>
						<span></span><img src="images/baxi.jpg" />
							...
							<h4>¥ 59.00</h4>
							<div> <input type="button" value="查看详情" /><button><a href="addGoods.jsp?path=baxi.jpg&&Id=08&&name=巴西咖啡豆&&decribe=润口顺滑 杏仁甘甜&&price=￥ 59.00&&color=灰色  ">加入购物车</a> </button> </div>
                         </li>
					</ul>
				</div>
</div>
